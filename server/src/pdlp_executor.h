#ifndef ORTOOLS_WASM_SERVER_PDLP_EXECUTOR_H_
#define ORTOOLS_WASM_SERVER_PDLP_EXECUTOR_H_

#include "server/src/solver_executor.h"

namespace ortools_wasm::server {

class PdlpExecutor final : public SolverExecutor {
 public:
...
#endif  // ORTOOLS_WASM_SERVER_PDLP_EXECUTOR_H_
