#ifndef ORTOOLS_WASM_SERVER_NETWORK_FLOW_EXECUTOR_H_
#define ORTOOLS_WASM_SERVER_NETWORK_FLOW_EXECUTOR_H_

#include "server/src/solver_executor.h"

namespace ortools_wasm::server {

class NetworkFlowExecutor final : public SolverExecutor {
 public:
...
#endif  // ORTOOLS_WASM_SERVER_NETWORK_FLOW_EXECUTOR_H_
