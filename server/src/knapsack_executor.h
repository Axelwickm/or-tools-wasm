#ifndef ORTOOLS_WASM_SERVER_KNAPSACK_EXECUTOR_H_
#define ORTOOLS_WASM_SERVER_KNAPSACK_EXECUTOR_H_

#include "server/src/solver_executor.h"

namespace ortools_wasm::server {

class KnapsackExecutor final : public SolverExecutor {
 public:
...
#endif  // ORTOOLS_WASM_SERVER_KNAPSACK_EXECUTOR_H_
