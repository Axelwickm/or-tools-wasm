...
export type SolverBridgeRequest = Message<"ortools_wasm.bridge.v1.SolverBridgeRequest"> & {
  ...
  /**
   * @generated from field: ortools_wasm.bridge.v1.SolverResourceRequest resources = 3;
   */
  resources?: SolverResourceRequest | undefined;
...
export type SolverBridgeRequestJson = {
   ...
   * @generated from field: ortools_wasm.bridge.v1.SolverResourceRequest resources = 3;
   */
  resources?: SolverResourceRequestJson;
...
/**
 * @generated from message ortools_wasm.bridge.v1.SolverResourceRequest
 */
export type SolverResourceRequest = Message<"ortools_wasm.bridge.v1.SolverResourceRequest"> & {
  /**
   * 0 means that the scheduler should use the solver's default requirement.
   *
   * @generated from field: uint32 threads = 1;
   */
  threads: number;
};
 ...
 * @generated from message ortools_wasm.bridge.v1.SolverResourceRequest
 */
export type SolverResourceRequestJson = {
  /**
   * 0 means that the scheduler should use the solver's default requirement.
   *
   * @generated from field: uint32 threads = 1;
...
export type SolverResourceRequestValid = SolverResourceRequest;

/**
 * Describes the message ortools_wasm.bridge.v1.SolverResourceRequest.
 * Use `create(SolverResourceRequestSchema)` to create a new message.
 */
export const SolverResourceRequestSchema: GenMessage<SolverResourceRequest, {jsonType: SolverResourceRequestJson, validType: SolverResourceRequestValid}> = /*@__PURE__*/
