...
if(CMAKE_SYSTEM_NAME STREQUAL "Emscripten")
  ...
  option(EMSCRIPTEN_USE_SIMD "Enable SIMD when targeting Emscripten" ON)
  message(STATUS "Emscripten SIMD support: ${EMSCRIPTEN_USE_SIMD}")
  if(EMSCRIPTEN_USE_SIMD)
    list(APPEND OR_TOOLS_COMPILE_OPTIONS "-msimd128")
    list(APPEND OR_TOOLS_LINK_OPTIONS "-msimd128")
  endif()
endif()
